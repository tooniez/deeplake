...
void table_storage::load_table_metadata()
{
    ...
    // DDL WAL replay is handled exclusively by the sync_worker background process.
    // Client connections just read tables from pg_catalog (populated by sync_worker).
